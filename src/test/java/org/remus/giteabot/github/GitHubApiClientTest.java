 ...
 * {@link RepositoryApiClient} and exposes the expected base URL and token.
 */
class GitHubApiClientTest {

    @Test
    void implementsRepositoryApiClient() {
        GitHubApiClient client = new GitHubApiClient(null, "https://api.github.com", "ghp_token");
    ...
    void constructorWithEnterpriseUrl() {
        GitHubApiClient client = new GitHubApiClient(null, "https://github.example.com/api/v3", "token123");
